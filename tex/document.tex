...
%% Last update lun. 07 déc. 2009 23:21:41 CET Philippe THIERRY
%%
...
\usepackage[utf8]{inputenc}				% char format
...
\usepackage{textcomp}					%
\usepackage[left=2.5cm,right=2.5cm,top=2.2cm,bottom=4.5cm]{geometry}
...
% charts support
\usepackage{pstricks}
\usepackage[Lenny]{fncychap}				% 'lenny' chapter titles
\SpecialCoor
...
\backmatter						% starting TOC chapters
...
\input{includes/problematique.tex}
\setcounter{chapter}{3}

% first part : state of art
\part{État de l'art des solutions d'ordonnancement}
\input{includes/state_of_art_WCET.tex}
\setcounter{chapter}{4}
\input{includes/state_of_art_IOSCHED.tex}
\setcounter{chapter}{5}
\input{includes/state_of_art_RTSCHED.tex}
\setcounter{chapter}{6}
\input{includes/state_of_art_SMPSCHED.tex}
\setcounter{chapter}{7}

\part{État de l'art des solutions de traitement de flux temps réel}
\input{includes/state_of_art_XENOMAI.tex}
\setcounter{chapter}{8}
\input{includes/state_of_art_RTAI.tex}
\setcounter{chapter}{9}
\input{includes/state_of_art_LITMUSRT.tex}
