...
%% Last update Fri Mar 12 15:27:37 2010 Philippe THIERRY
%%
...
\input{includes/\lang/part1/state_of_art_WCET.tex}
\setcounter{chapter}{4}
\input{includes/\lang/part1/state_of_art_IOSCHED.tex}
\setcounter{chapter}{5}
\input{includes/\lang/part1/state_of_art_RTSCHED.tex}
\setcounter{chapter}{6}
\input{includes/\lang/part1/state_of_art_SMPSCHED.tex}
\setcounter{chapter}{7}

% part 2 title
\input{includes/\lang/part2/title.tex}

\input{includes/\lang/part2/state_of_art_XENOMAI.tex}
\setcounter{chapter}{8}
\input{includes/\lang/part2/state_of_art_RTAI.tex}
\setcounter{chapter}{9}
\input{includes/\lang/part2/state_of_art_LITMUSRT.tex}
