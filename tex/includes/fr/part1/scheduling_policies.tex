...
%% Last update Wed Mar 17 13:10:27 2010 Philippe THIERRY
%%
...
\paragraph{}
Les différents ordonnanceurs temps réel possèdent plusieures propriétés quant à la gestion des taches.
...
\paragraph{}
La politique d'ordonnancement est définie par avance. Elle est donc optimisée pour un cas particulier de set
de taches, mais pose problème en cas d'impact non prévu sur la dynamique d'exécution (effets de caches, de surcharge
...
une tache s'exécute en plusieurs fois. Cela a pour conséquence que l'ordonnanceur s'exécute plus souvent que
...
\paragraph{}
Le schéma suivant décrit l'automate générique caractérisant les différents états d'une tache, dans le cadre d'un ordonnancement préemptif :
\begin{figure}[h]
...
statiquement. Cela pose cependant la problématique de l'impact des locks (besoin de
...
tout variation des hypothèses (inexactitude de WCET, surcharge temporelle) impacte violemment
