...
%% Last update Thu Mar 18 15:52:01 2010 Philippe THIERRY
%%
...
\paragraph{}
Les interruptions matérielle sont des évènements asyncrhones émis par le matériel pour générer de manière synchrone l'exécution d'un
...
qui les relaie au processeur. Ce dernier stop sont cycle d'exécution courrant, pour exécuter un {\it handler d'IRQ}, que le noyau
...
\begin{enumerate}
\item Cache level 1, le plus petit et accessible le plus rapidement, ce cache est spécialisé : il définit un conteneur dit {\it cache code},
...
La cellule choisie est celle étant la moins récemment utilisée, cela implique, pour chaque paire de cellules du cache,
un champ indiquant laquelle est la moins récemment utilisée.
...
\subsubsection{Syncrhonisation caches/mémoire centrale}
\paragraph{}
...
Une écriture sur cache implique une remontée de la mise à jour de la donnée, afin de maintenir une cohésion.
