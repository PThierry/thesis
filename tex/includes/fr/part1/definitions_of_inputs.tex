...
%% Last update Thu Mar 25 16:26:45 2010 Philippe THIERRY
%%

\chapter{ÉTAT DE L'ART DE LA MESURE ET DE L'EMPLOI DU WCET}
\doMinitoc
...
dont le dépassement peut avoir un impact fort sur le bon fonctionnement du système. Il peut s'agit par exemple de
systèmes de gestion des commandes de bord, des systèmes satélitaires ou militaires.
\item Les systèmes temps réel souples, où le dépassement de la date limite de fin d'exécution est acceptable
à partir du moment où sa fréquence reste faible. Dans ce cadre, le respect du temps limite d'exécution correspond
...
\paragraph{}
Le temps maximum $T_{m}(\tau_{i})$ pouvant se dérouler entre l'arrivée d'une tache $\tau_{i}$
et sa terminaison se décompose comme suit :
$$T_{m}(\tau_{i}) = T_{e}(\tau_{i}) + \Delta T$$
...
\section{État de l'art de l'estimation du WCET}
...
\section{Les éléments non-mesurés}
...
\section{État de l'art de l'emploi du WCET}
