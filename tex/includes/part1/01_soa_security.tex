...
Lagadec de la Direction Générale de l'Armement (DGA) en 2006 \cite{sstic2006diode},
...
sécurité différents. Cet environnement d'exécution est appelé un {\it
Separation Kernel}. Le principe de Separation Kernel a été initialement
défini en 1981 \cite{securedesign} et reste aujourd'hui d'actualité, au travers d'un
...
besoins sont plus récents, conséquence des exigences venant de l'avionique et
du domaine véhiculaire, pour lesquelles les produits de sécurité ne sont pas encore
définis.\\
...
Kernel. Ce choix s'appuie sur un état de l'art des différentes solutions de
