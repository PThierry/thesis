...
quatres propriétés des systèmes MILS sont alors respectées.
...
définit en 1981\cite{sk_def} et reste aujourd'hui d'actualité, suite à la
définition des systèmes MILS par la NSA en 2001\FIXME{citer NSA 2001}.

\paragraph{}
Parmis les mécanismes de séparation des domaines tels que décrit par la NSA
...
\FIXME{cite recherche et brevets}. Les systèmes MILS requiers, en plus des
différentes fonctions de sécurité dont le nombre et la complexité dépendent du
niveau de certification demandé, requièrent des propriétés comportementales
fortes de la part du Separation Kernel:
\begin{requirement}
Le Separation Kernel doit assurer une séparation spatiale stricte
\end{requirement}
...
architecture matérielle partagée}
