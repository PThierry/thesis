...
\chapter{Sécurisation d'une plateforme de traitement réseau multi-domaines de sécurité}
\doMinitoc
...
diode s'appuie sur deux {\it guichets}, comme le décrit la Figure \ref{fig:diodephy} :
\begin{itemize}
...
Communs pour un coût raisonnable.
...
architecture distribuée de sous-systèmes communiquant de manière sécurisée en
