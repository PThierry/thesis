...
\chapter{Etat de l'art de l'ordonnancement temps-réel}
\doMinitoc
...
l'état de l'art de ces deux thèmes.}



\section{A propos de l'ordonnancement hiérarchique de tâches}
...
\subsubsection{A propos de l'ordonnancement d'un ensemble de tâches à criticité mixte}
...
tâches indépendantes à deadline contraintes, l'approche modifié du principe
d'Audsley par Vestal était optimale pour les algorithmes de priorisation
d'ensembles de tâches à criticité mixte.
...
la passerelle Systronique, la découpe entre tâche est maintenue en TDM pour
...
de tâches afin d'assurer son ordonnançabilité dans cet état à criticté
augmenté.\\
...
performance maximum de ce dernier. Dans la partie \ref{sec:mixedcrit}, je
décrit la solution proposée, en m'appuyant sur les principes de criticité mixte.
