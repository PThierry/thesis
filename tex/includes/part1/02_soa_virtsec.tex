...
\paragraph{}
{\it Les solutions de virtualisation sont un bon candidat pour répondre au besoin
...
fournissent une architecture logicielle compatible du principe de {\it
separation kernel} comme décrit il y a plus de 20 ans par John Rushby
\cite{rushby1989kernels}. Dans ce chapitre, je décrit les différentes
solutions existantes de type {\it separation kernel}, s'appuyant sur ce même
principe ou dont le but est la compartimentation logicielle.}
...
de l'émetteur puis renvoyé vers le
destinataire\cite{apparao2006characterization}.
...
d'exécutions pour chaque type de donnée\cite{gadaleta2012effectiveness}.\\
...
\paragraph{}
La famille L4 est composé de différents micro-noyaux écrits en C++, comme
...
porté sur un grand nombre d'architectures, dont ARM, PowerPC ou MIPS. Seul
...
exigences temps réel et de sécurité. Il est de plus nécessaire, afin de
...
ordonnancé par ce dernier, tout en assurant une compartimentation spatiale et
temporelle forte.\\
Parmi les différentes solution de virtualisation étudiées, seule la solution
...
de sécurité.
\FIXME{définir les exigences de la solution dans la Problématique}
