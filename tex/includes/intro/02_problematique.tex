...
d'armes, en charge de débrayer les mécanismes d'attaque lors de l'ouverture d'une
...
technologies de l'information \cite{cc_docs}. Ceux-ci définissent 7 niveaux, appelés EAL
...
\begin{itemize}
  ...
  ceux-ci sont ni trop combreux ni consécutifs) ;
...
\begin{itemize}
  ...
  \item le système d'armes, ayant ces mêmes propriétés ;
