...
confidentialité est assuré par le chiffrement, le cloisonnement des
...
garanti. Ce cloisonnement est exigé pour des raisons de sureté pour que le
...
\paragraph{}
Dans les systèmes embarqués militaires, des réseaux dont la confidentialité,
l'intégrité et/ou la disponibilité des données peuvent être différentes nécessitent
d'être interconnectés. On parle alors de réseaux de différents domaines de
sécurité.\\
L'interconnexion de domaines de sécurité hétérogènes a été solutionnée dans les systèmes d'informations,
au travers de l'usage de chiffreurs, de filtres et d'éléments matériels en
coupure. Ces solutions restent difficile à intégrer sur les systèmes embarqués
du fait de leur volume, de leur poids et de leur consommation électrique.
...
des passagers. En conséquence, ils ont également des contraintes de sûreté.\\
...
systèmes avioniques ou véhiculaires. Plus les dégâts consécutifs à une panne
sont importants, plus le niveau d'exigence de temps-réel est élevé.
