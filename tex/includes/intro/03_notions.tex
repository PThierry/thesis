...
initialement une cible d'évaluation (couramment appelée TOE, pour {\it Target
Of Evaluation}) \cite{cnssi_4009}, intégrant ce qui, dans le
...
\paragraph{}
Associé à la TOE, on définit le socle de confiance (couramment appelé
TCB, pour {\it Trusted Computing Base}) \cite{cnssi_4009}. Cette
