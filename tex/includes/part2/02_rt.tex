...
\begin{requirement}
It should be possible to allow domains with various levels of criticality to communicate\label{req:multi_crit}
\end{requirement}

\begin{requirement}
The traversal time between multi-critical networks should be
upper-bounded\label{req:rt}
\end{requirement}

\begin{requirement}
According to the needs, a minimum flow rate should be
guaranteed for each flow\label{req:debit}
\end{requirement}
