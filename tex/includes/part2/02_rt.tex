...
%% Last update jeu. 10 avril 2014 10:25:04 CEST phil
...
\end{tabular}
\end{center}
\caption{Description de la cible pour la mesure de latence d'ordonnancement avec Linux-RT\label{tab:rttest}}
\end{table}
...
tâches nécessaire aux divers traitements. L'Exigence \hyperlink{REQTEMPS002},
