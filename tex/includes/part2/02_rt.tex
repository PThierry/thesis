...
\subsection{A propos des exigences temps-réel}
...
\subsection{Déterminaison de la MC-ordonnançabilité}\label{sufficientCondition}
...
\begin{proposition}
Soit $\tau$ un ensemble de taches à criticité mixte MC-ordonnançable. Il en
...
\begin{proposition}
Tout ensemble de taches à criticité mixte $\tau$ qui est MC-ordonnançable
...
MC-ordonnançable dans l'exemple \ref{ex:mcTaskSet2}. La Figure
...
MC-ordonnançable. Dès que un instant d'inactivité de niveau $\ell$ se produit
...
t_{\text{idle}}$). On distingue deux cas:
 ...
 \begin{enumerate}
	\item $t_i$ est l'instant critique pour $\tau_i$: il en suit que le
          ...
          instancié par $\tau_i$. Mais comme $\tau$ est MC-ordonnançable, nous
