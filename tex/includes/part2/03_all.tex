...
\paragraph{}
La conséquence de la problématique décrite en \ref{subsec:systronic_problematique} et que
...
\paragraph{}
La configuration de la maquette et le flux d'entrée est décrit dans la Table \ref{tab:dut}.\\
\begin{table}
\begin{center}
\begin{tabular}{|l|l|}
  \hline
