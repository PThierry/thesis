...
sur un même matériel. Cete exigence correspond à l'Exigence REQ\_SECUR\_005
...
contrainte correspond à l'Exigence REQ\_SECUR\_001 du Chapitre
\ref{sec:matrix}.
...
sécurité. Cette exigence correspond à l'Exigence REQ\_SECUR\_003 de la matrice
...
\begin{itemize}
  ...
  REQ\_SECUR\_002, est partagée entre:
    \begin{itemize}
  ...
  \item L'intégrité des données est assurée par la passerelle durant le temps
    de leur transit (en réponse à l'Exigence REQ\_SECUR\_003).
  \item Comme précisé dans le cadre de la matrice de conformité aux
    ...
    est donc incompatible de l'Exigence REQ\_SECUR\_004 du Chapitre
    \ref{sec:matrix} 
\end{itemize}
...
à l'exigence REQ\_SECUR\_001 du Chapitre \ref{sec:matrix}, 
...
la problématique générale de la thèse (REQ\_SECUR\_001 à REQ\_SECUR\_006).
...
l'exigence REQ\_SECUR\_003. L'intégrité des données transmises est une
...
\paragraph{}
Le moniteur de sécurité décrit ici répond à l'exigence REQ\_SECUR\_001.
...
de plus haut niveau (Exigence REQ\_SECUR\_001)
\item Le transfert de flux désensibilisé d'un domaine de plus haut niveau de
sécurité vers un domaine de plus faible niveau de sécurité (Exigence REQ\_SECUR\_006)
\end{enumerate}
...
\cite{thierry2013dctrl}\cite{thierry2013audit}
et à l'implémentation d'un moniteur de sécurité permettant de
répondre aux exigences REQ\_SECUR\_001 et REQ\_SECUR\_006, sans nécessiter l'usage de plusieurs matériels
distinct.\\
...
compatible avec l'exigence REQ\_MAINT\_002. Ce dernier ne nécessite par contre
...
avec l'exigence REQ\_MAINT\_001.
...
par construction, le rendant compatible de l'exigence REQ\_TEMPS\_001.\\
...
avec les Exigences MILS et pour pouvoir répondre à l'Exigence \label{req:escape},
...
mémoire allouée à chaque compartiment est compatible avec la politique de
...
\begin{itemize}
  \item La taille d'un slot (en nombre de lignes de cache) doit être
    compatible avec l'algorithme pseudo-LRU 4-ways.
