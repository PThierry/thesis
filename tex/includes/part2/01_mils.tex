...
\paragraph{}
J'ai définit dans les Sections \ref{sec:mls_gw_principles} et
...
Security). Suite à la définition de ces principes généraux, permettant d'être
...
d'EBIOS\cite{hemery2007utilisation}.
...
(financier, managérial) associé au risque sécuritaire, sa présence n'est plus requise.
