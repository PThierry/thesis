...
\subsubsection{Poriblématique générale}
...
d'adressage IP est problématique dans le respect de l'Exigence
...
ne soient pas capable de déterminer tout ou partie des informations télécom
...
\end{itemize}
On parle alors d'un mécanisme de séparation protocolaire\FIXME{ref}. Ces
mécanismes implique l'usage d'applications de type proxy, se substituant d'une
