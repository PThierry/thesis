...
\paragraph{}
Afin de répondre à la problématique de ma thèse, il est
nécessaire de définir une solution répondant aux besoins de MultiLevel Security
(MLS). Cela implique un mécanisme assurant une étanchéité des
...
Separation Kernel. De plus, il est nécessaire de définir une architecture
logicielle complète au dessus du Separation Kernel afin de répondre aux
exigences fonctionnelles et sécuritaires de la problématique de ma thèse.
...
\paragraph{}
Il est montré dans la Section précédante que la présence d'éléments logiciels
