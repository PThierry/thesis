...
multi-domaines de sécurité nécessite de répondre aux intérogations suivantes:
\begin{itemize}
  \item Quels sont les données à protéger ?
  \item Quel(s) type(s) de protection la passerelle doit fournir sur ces
    données (confidentialité, intégrité, disponibilité) ?
  \item Quels sont les fonctions de sécurité nécessaires pour répondre à ces
    besoin ?
\end{itemize}
