...
\paragraph{}
De la définition des Exigences \ref{req:integrity}, \ref{req:transit} et
\ref{req:desensibilisation}, il faut dériver des exigences techniques. Pour
cela, je détermine d'abord la surface d'attaque. On appelle surface d'attaque
les éléments d'interface à partir desquels on considère une attaque possible.
...
\begin{enumerate}
  ...
  \item Les attaques internes, venant des éléments de la passerelle
    appartenant à la famille $Unsec$, telle que décrite dans la Section \ref{sec:noncert}
\end{enumerate}
...
protection associée. Dans le cadre de ma thèse, je considère cependant le
...
\subsubsection{Du choix des propriétés de sécurité qui doivent être apportés à ces données}
\paragraph{}
