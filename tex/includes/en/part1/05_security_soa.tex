...
%% Last update Mon Apr  4 17:50:21 2011 Philippe THIERRY
%%

\chapter{General principles of the security of Information \& Technologies}

{\it
This chapter fastly describes the security functions and threats considered in this document.
...
\paragraph{\index{Cache!Consistance}Cache consistance}
...
\paragraph{Synchronising cache with the main memory}
\paragraph{}
...
\paragraph{Cache management algorithms}
...
\index{DMA}DMA  se   fait   directement   vers   une   adresse   physique   en   mémoire
centrale.\\
